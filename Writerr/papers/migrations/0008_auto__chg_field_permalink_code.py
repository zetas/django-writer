...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Permalink.code'
        db.alter_column(u'papers_permalink', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Permalink.code'
        db.alter_column(u'papers_permalink', 'code', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))
    ...
    models = {
        ...
        u'papers.permalink': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': '1', 'unique': 'True', 'max_length': '255'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paper': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['papers.Paper']"})
        }
