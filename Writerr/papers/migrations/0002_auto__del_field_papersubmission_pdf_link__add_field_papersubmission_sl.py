...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaperSubmission.pdf_link'
        db.delete_column(u'papers_papersubmission', 'pdf_link')

        # Adding field 'PaperSubmission.slug'
        db.add_column(u'papers_papersubmission', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PaperSubmission.pdf_link'
        db.add_column(u'papers_papersubmission', 'pdf_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'PaperSubmission.slug'
        db.delete_column(u'papers_papersubmission', 'slug')
