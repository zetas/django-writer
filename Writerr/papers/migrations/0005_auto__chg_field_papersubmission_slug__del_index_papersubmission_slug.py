...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'papers_papersubmission', 'slug', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Removing index on 'PaperSubmission', fields ['slug']
        db.delete_index(u'papers_papersubmission', ['slug'])
