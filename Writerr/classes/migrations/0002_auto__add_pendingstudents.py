...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingStudents'
        db.create_table(u'classes_pendingstudents', (
        ...
        db.send_create_signal(u'classes', ['PendingStudents'])


    def backwards(self, orm):
        # Deleting model 'PendingStudents'
        db.delete_table(u'classes_pendingstudents')
    ...
    models = {
        ...
        u'classes.classroom': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'TLZHFWM5'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'classes.pendingstudents': {
            'Meta': {'object_name': 'PendingStudents'},
            'classroom': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['classes.Classroom']"}),
            'creation': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
