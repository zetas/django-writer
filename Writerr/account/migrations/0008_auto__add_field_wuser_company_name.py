...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WUser.company_name'
        db.add_column(u'account_wuser', 'company_name',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WUser.company_name'
        db.delete_column(u'account_wuser', 'company_name')
    ...
    models = {
        u'account.license': {
            ...
            'redemption_code': ('django.db.models.fields.CharField', [], {'default': "'3U38M5-H1VP7D-B99E1M-0BHSV8'", 'unique': 'True', 'max_length': '255'}),
