...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WUser.country'
        db.add_column(u'account_wuser', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WUser.country'
        db.delete_column(u'account_wuser', 'country')
    ...
    models = {
        u'account.license': {
            ...
            'redemption_code': ('django.db.models.fields.CharField', [], {'default': "'T7VCJI-CTX6TI-JMMKRK-AZ5E8Q'", 'unique': 'True', 'max_length': '255'}),
