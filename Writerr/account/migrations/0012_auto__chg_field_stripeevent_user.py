...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StripeEvent.user'
        db.alter_column(u'account_stripeevent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.WUser']))

    def backwards(self, orm):

        # Changing field 'StripeEvent.user'
        db.alter_column(u'account_stripeevent', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['account.WUser']))
    ...
    models = {
        u'account.license': {
            ...
            'redemption_code': ('django.db.models.fields.CharField', [], {'default': "'OGXSFJ-P7NKAY-9O70H1-4GLBUM'", 'unique': 'True', 'max_length': '255'}),
