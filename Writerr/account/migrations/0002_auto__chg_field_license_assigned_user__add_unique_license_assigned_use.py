...
class Migration(SchemaMigration):
    ...
    models = {
        u'account.license': {
            ...
            'assigned_user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'license'", 'unique': 'True', 'null': 'True', 'to': u"orm['account.WUser']"}),
            ...
            'redemption_code': ('django.db.models.fields.CharField', [], {'default': "'AX74BN-TA3M6V-5H0A1A-SJP923'", 'unique': 'True', 'max_length': '255'}),
