...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'account_wuser', 'stripe_customer_id', self.gf('django.db.models.fields.CharField')(default='NULL', max_length=255))
    ...
    models = {
        u'account.license': {
            ...
            'redemption_code': ('django.db.models.fields.CharField', [], {'default': "'GFXFMK-KYK5FZ-YR9L0B-PB3N6S'", 'unique': 'True', 'max_length': '255'}),
