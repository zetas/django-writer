...
Vagrant.configure("2") do |config|
  config.vm.define :web do |web|
    ...
    # Network
    web.vm.hostname = "writerr-vagrant.qubitlogic.net"
    web.vm.network :forwarded_port, guest: 80, host: 8080, auto_correct: true
    web.vm.network :forwarded_port, guest: 22, host: 22, auto_correct: true
    ...
    web.vm.provision :salt do |salt|
      ...
      salt.minion_key = "salt/keys/writerr-vagrant.qubitlogic.net.pem"
      salt.minion_pub = "salt/keys/writerr-vagrant.qubitlogic.net.pub"
