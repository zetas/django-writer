...
# Server paths
PROJECT_NAME = "writerr"
PROJECT_PATH = "/vagrant/Writerr"

MANAGE_BIN = "/vagrant/Writerr/manage.py"
...
def manage_py(command):
    ...
    run('source /home/vagrant/.env && {python} {manage} {command}'.format(python=VENV_PATH + "/bin/python",
                                             manage=MANAGE_BIN,
                                             command=command))
